...
# I have used isubq for negating values in abscopy.ys . It costs less than
# regular subq according to the my tests. So it was necessary to change isubq
# here as well.

# To Implement IISUBQ, I have done followings:
# First of all, "instr_valid", "need_regids", and "need_valC" should be set. 

# Because I need to implement following in fetch stage.
# 	icode:ifun <- M1[PC]
# 	rA:rB <- M1[PC+1]
# 	valC <- M8[PC+2]
# 	valP <- PC+10

# in decode phase, I need to implement this.
# 	valB <- R[rB]
# to achieve this, srcB should be set rB.
# I do not need srcA in this operation.

# in execute phase I need to implement this.
# 	valE <- valC OP(isubq) valB
# 	Set CC
# I need to order operands properly. To do so, my first operand should be
# valB, and my second operand should be valC. To achieve this, I have set aluA as
# valB, and set aluB as valC.
# And I should do correct operation for ISUBBQ which is "ALUSUB". To achieve this, 
# I should set "alufun" as "ALUSUB".
# Also, to set condition codes, I need to "set_cc" if it is IISUBQ.

# in memory phase, I have nothing to do.
# 	-

# in write back phase, I need to implement this.
# 	R[rB] <- valE
# "What register should be used as the E destination?" the answer of
# this question is rB. So I have set it so.

# and as final phase, I need to implement this on PC update phase
# 	PC <- valP

# Also I try to change other things to implement forwarding etc. but I
# do not think they work because I couldnt managed to get any improvement.
...
## You can implement the isubq instruction if you like. Pretty easy since
...
# Instruction code for isubq instruction
